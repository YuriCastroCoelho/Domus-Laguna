...
const Header = () => {
    ...
    // Reconfere o usuário logado a cada troca de rota (não só no mount),
    // assim o cabeçalho não fica "travado" mostrando Entrar/Sair desatualizado
    // depois de um login/logout em outra página da SPA.
    useEffect(() => {
